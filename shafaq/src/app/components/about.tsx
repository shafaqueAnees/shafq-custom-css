      ...
      <div className="container">
        ...
        <div className="img-section">
          ...
          id="about-img"
            ...
            height={400}
            alt={"about-logo"}
            src={require("../../../public/picture/image.jpg")}
          ></Image>
        </div>
      </div>
    </section>
